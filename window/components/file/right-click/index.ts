import {FilesystemItem} from 'window/types';
import {ContextMenuItem} from 'window/components/ContextMenu';
import {DiscoveredAppDefinition} from 'window/contexts/AppContext';
